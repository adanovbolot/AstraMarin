# Generated by Django 4.2 on 2023-05-24 19:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operator', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='server.pointssale', verbose_name='Оператор')),
        ...
        migrations.CreateModel(
            name='SalesСollection',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sales_date', models.DateField(auto_now_add=True, verbose_name='Дата продаж')),
                ('total_adult_quantity', models.PositiveIntegerField(verbose_name='Общее количество взрослых')),
                ('total_child_quantity', models.PositiveIntegerField(verbose_name='Общее количество детей')),
                ('total_amount', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='Общая сумма')),
                ('operator', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='server.pointssale', verbose_name='Оператор')),
                ('tickets', models.ManyToManyField(to='server.tickets', verbose_name='Билеты')),
            ],
            options={
