# Generated by Django 4.2 on 2023-05-12 19:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('berths', models.CharField(blank=True, max_length=100, null=True, verbose_name='Причал')),
            ],
            options={
                'verbose_name': 'Причал',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_check', models.TextField(blank=True, null=True, verbose_name='Данные чека')),
                ...
                ('qr_code', models.ImageField(blank=True, null=True, upload_to='tickets/qr_codes/', verbose_name='QR код')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[(1, 'Открытая смена'), (2, 'Архив')], default=1, max_length=3, null=True, verbose_name='Статус смены')),
